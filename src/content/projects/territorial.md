...
Territorial es un proyecto frontend que hice para la universidad: una plataforma con un mapa interactivo
para visualizar y explorar información territorial, construida con Next.js y Tailwind CSS.
